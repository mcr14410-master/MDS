...
const machineTypesRoutes = require('./routes/machineTypesRoutes');
const controlTypesRoutes = require('./routes/controlTypesRoutes');
...
const customerDocumentsRoutes = require('./routes/customerDocumentsRoutes');
...
app.use('/api/control-types', controlTypesRoutes);
...
app.use('/api/customers', customerDocumentsRoutes);
