    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          {/* Basis-Daten */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Basis-Daten</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Name * <span className="text-xs text-gray-500">(z.B. DMG-DMU50)</span>
                </label>
                <input
                  type="text"
                  name="name"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Maschinentyp</label>
                <select
                  name="machine_type"
          ...
          {/* Steuerung */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Steuerung</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Steuerungstyp</label>
                <select
                  name="control_type"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Steuerungsversion</label>
                <input
                  type="text"
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Achsen</label>
                <input
                  type="number"
                  name="num_axes"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Werkzeugplätze</label>
                <input
                  type="number"
                  name="tool_capacity"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Spindelleistung (kW)</label>
                <input
                  type="number"
                  name="spindle_power"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Max. Drehzahl (U/min)</label>
                <input
                  type="number"
                  name="max_rpm"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Arbeitsraum X (mm)</label>
                <input
                  type="number"
                  name="workspace_x"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Arbeitsraum Y (mm)</label>
                <input
                  type="number"
                  name="workspace_y"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Arbeitsraum Z (mm)</label>
                <input
                  type="number"
                  name="workspace_z"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Betriebsstunden</label>
                <input
                  type="number"
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Standort & Integration</h3>
            <div className="grid grid-cols-1 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Netzwerkpfad (SMB)</label>
                <input
                  type="text"
                  name="network_path"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Postprozessor-Name (für CAM)</label>
                <input
                  type="text"
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label className="text-sm font-medium text-gray-700">Maschine ist aktiv</label>
              </div>
            </div>
          </div>
