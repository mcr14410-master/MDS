        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                  errors.op_number ? 'border-red-500' : 'border-gray-300'
                }`}
                placeholder="z.B. OP10"
                disabled={loading}
              />
              {errors.op_number && (
                <p className="mt-1 text-sm text-red-600">{errors.op_number}</p>
              )}
            </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                errors.op_name ? 'border-red-500' : 'border-gray-300'
              }`}
              placeholder="z.B. Drehen Außendurchmesser"
              disabled={loading}
            />
            {errors.op_name && (
              <p className="mt-1 text-sm text-red-600">{errors.op_name}</p>
            )}
          </div>
