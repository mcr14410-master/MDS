...
export default function FixtureTypesModal({ onClose }) {
  const { types, fetchTypes, createType, updateType, deleteType } = useFixturesStore();
  ...
  const handleDelete = async (type) => {
    if (type.fixture_count > 0) {
      toast.error(`Typ "${type.name}" wird noch von ${type.fixture_count} Vorrichtung(en) verwendet`);
      return;
    }
  ...
  const iconOptions = [
    { value: 'box', label: '📦 Aufspannvorrichtung' },
    { value: 'flame', label: '🔥 Schweißvorrichtung' },
    { value: 'wrench', label: '🔧 Montagevorrichtung' },
    { value: 'check-circle', label: '✓ Prüfvorrichtung' },
    { value: 'ruler', label: '📏 Messvorrichtung' },
    { value: 'circle', label: '○ Bohrvorrichtung' },
    { value: 'square', label: '□ Fräsvorrichtung' },
    { value: 'rotate-cw', label: '↻ Drehvorrichtung' },
    { value: 'disc', label: '◉ Schleifvorrichtung' },
    { value: 'tool', label: '🔧 Sondervorrichtung' },
  ];
          ...
          <div className="p-6 max-h-[60vh] overflow-y-auto">
            ...
            {!showForm && (
              <button
                ...
                className="w-full mb-4 px-4 py-2 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg text-gray-600 dark:text-gray-400 hover:border-indigo-500 hover:text-indigo-500 dark:hover:border-indigo-500 dark:hover:text-indigo-400 transition-colors"
              >
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      placeholder="z.B. Laservorrichtung"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500 dark:text-gray-400">
                        {type.fixture_count || 0} Vorrichtungen
