...
export default function ClampingDeviceTypesModal({ onClose }) {
  const { types, fetchTypes, createType, updateType, deleteType } = useClampingDevicesStore();
  ...
  const handleEdit = (type) => {
    setFormData({
      ...
      icon: type.icon || 'grip-horizontal',
  ...
  const handleDelete = async (type) => {
    if (type.device_count > 0) {
      toast.error(`Typ "${type.name}" wird noch von ${type.device_count} Spannmittel(n) verwendet`);
      return;
    }
  ...
  const iconOptions = [
    { value: 'grip-horizontal', label: '☰ Schraubstock' },
    { value: 'arrow-down-to-line', label: '⬇ Spannpratze' },
    { value: 'minus', label: '— Spanneisen' },
    { value: 'circle', label: '○ Spannzange' },
    { value: 'circle-dot', label: '⊙ Spannfutter' },
    { value: 'cylinder', label: '⬤ Spannhülse' },
    { value: 'magnet', label: '🧲 Magnetspannplatte' },
    { value: 'wind', label: '💨 Vakuumspannung' },
    { value: 'crosshair', label: '⊕ Nullpunkt-System' },
    { value: 'square', label: '□ Palette' },
    { value: 'corner-right-down', label: '⌐ Winkelplatte' },
    { value: 'rotate-cw', label: '↻ Teilapparat' },
    { value: 'arrow-right', label: '→ Reitstock' },
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div className="col-span-2">
                    ...
                    <input
                      ...
                      placeholder="z.B. Hydraulik-Schraubstock"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500 dark:text-gray-400">
                        {type.device_count || 0} Spannmittel
