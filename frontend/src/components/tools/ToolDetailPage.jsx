    ...
    return (
      <div className="space-y-6 p-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-red-500/20 border border-red-500/30 text-red-600 dark:text-red-400 px-4 py-3 rounded-md">
            {error || 'Werkzeug nicht gefunden'}
          </div>
          <button
            onClick={() => navigate('/tools')}
            className="mt-4 flex items-center gap-2 text-blue-600 dark:text-blue-400 hover:text-blue-300"
          >
  ...
  return (
    <div className="space-y-6 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <button
          onClick={() => navigate('/tools')}
          className="flex items-center gap-2 text-blue-600 dark:text-blue-400 hover:text-blue-300 mb-6"
        >
          <ArrowLeft className="w-4 h-4" />
          Zurück zur Übersicht
        </button>
          ...
          <div className="flex items-start justify-between mb-4">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <span className="text-2xl font-bold text-blue-600 dark:text-blue-400">{currentTool.article_number}</span>
              ...
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{currentTool.tool_name}</h1>
              ...
              <div className="flex flex-wrap gap-2">
                ...
                {currentTool.subcategory_name && (
                  <span className="px-3 py-1 text-sm font-medium bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 rounded">
                    {currentTool.subcategory_name}
                  </span>
                )}
            ...
            <div className="flex items-center gap-2">
              ...
              {storageItems.length > 0 && (
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-900 dark:text-white rounded-md transition-colors"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Geometrie</h2>
            <div className="space-y-3">
              {currentTool.diameter && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Durchmesser:</span>
                  <span className="text-gray-900 dark:text-white font-medium">⌀{currentTool.diameter} mm</span>
                </div>
              )}
              {currentTool.length && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Länge:</span>
                  <span className="text-gray-900 dark:text-white font-medium">{currentTool.length} mm</span>
                </div>
              )}
              {currentTool.flutes && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Schneiden:</span>
                  <span className="text-gray-900 dark:text-white font-medium">Z{currentTool.flutes}</span>
                </div>
              )}
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Material & Beschichtung</h2>
            <div className="space-y-3">
              {currentTool.material && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Material:</span>
                  <span className="text-gray-900 dark:text-white font-medium">{currentTool.material}</span>
                </div>
              )}
              {currentTool.coating && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Beschichtung:</span>
                  <span className="text-gray-900 dark:text-white font-medium">{currentTool.coating}</span>
                </div>
              )}
              {currentTool.substrate_grade && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Substrat-Sorte:</span>
                  <span className="text-gray-900 dark:text-white font-medium">{currentTool.substrate_grade}</span>
                </div>
              )}
              {currentTool.hardness && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Härte:</span>
                  <span className="text-gray-900 dark:text-white font-medium">{currentTool.hardness}</span>
                </div>
              )}
          ...
          {/* Hersteller */}
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Hersteller</h2>
            <div className="space-y-3">
              {currentTool.manufacturer && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Hersteller:</span>
                  <span className="text-gray-900 dark:text-white font-medium">{currentTool.manufacturer}</span>
                </div>
              )}
              {currentTool.manufacturer_part_number && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Artikelnummer:</span>
                  <span className="text-gray-900 dark:text-white font-medium">{currentTool.manufacturer_part_number}</span>
                </div>
              )}
              {currentTool.shop_url && (
                <div className="flex justify-between">
                  <span className="text-gray-500 dark:text-gray-400">Shop-URL:</span>
                  <a
                    href={currentTool.shop_url}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-600 dark:text-blue-400 hover:text-blue-300 font-medium truncate max-w-xs"
                  >
                    Link öffnen
                  </a>
                </div>
          ...
          {/* Kosten & Sonstiges */}
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Sonstiges</h2>
            <div className="space-y-3">
              <div className="flex justify-between">
                <span className="text-gray-500 dark:text-gray-400">Verwendet Wendeplatten:</span>
                <span className="text-gray-900 dark:text-white font-medium">{currentTool.uses_inserts ? 'Ja' : 'Nein'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-500 dark:text-gray-400">Status:</span>
                <span className={`font-medium ${currentTool.is_active ? 'text-green-600 dark:text-green-400' : 'text-gray-500'}`}>
        ...
        {/* Notes */}
        {currentTool.notes && (
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 mt-6 border border-gray-200 dark:border-gray-700">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Notizen</h2>
            <p className="text-gray-700 dark:text-gray-300 whitespace-pre-wrap">{currentTool.notes}</p>
          </div>
        )}

        {/* Metadata */}
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 mt-6 border border-gray-200 dark:border-gray-700">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Metadaten</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
            {currentTool.created_by_username && (
              <div className="flex justify-between">
                <span className="text-gray-500 dark:text-gray-400">Erstellt von:</span>
                <span className="text-gray-700 dark:text-gray-300">{currentTool.created_by_username}</span>
              </div>
            )}
            ...
            {currentTool.updated_at && (
              <div className="flex justify-between">
                <span className="text-gray-500 dark:text-gray-400">Aktualisiert am:</span>
                <span className="text-gray-700 dark:text-gray-300">
          ...
          <div className="space-y-6">
            {storageItems && storageItems.length > 0 ? (
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Storage Item ID: {item.id}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {user?.permissions?.includes('storage.edit') && (
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-900 dark:text-white rounded-md transition-colors border border-gray-300 dark:border-gray-600"
                      >
                        <Edit className="w-4 h-4" />
                        Bearbeiten
                      </button>
                    ...
                    {user?.permissions?.includes('stock.scrap') && (
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-gray-600 hover:bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-white rounded-md transition-colors"
                      >
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg p-8 border border-gray-200 dark:border-gray-700 text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400 mb-4">Keine Lagerartikel für dieses Werkzeug vorhanden</p>
          ...
          <>
            {storageItems && storageItems.length > 0 ? (
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg p-12 border border-gray-200 dark:border-gray-700 text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Kein Lagerort zugewiesen</h3>
