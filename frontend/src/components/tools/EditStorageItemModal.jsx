        ...
        <div className="relative bg-gray-800 rounded-lg w-full max-w-2xl shadow-xl border border-gray-700">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-700">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white">Lagerartikel bearbeiten</h3>
          ...
          <form onSubmit={handleSubmit} className="px-6 py-4">
            <div className="space-y-6">
              ...
              <div className="bg-gray-750 rounded-lg p-4 border border-gray-600">
                <div className="text-sm text-gray-400 mb-2">Aktueller Bestand</div>
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    <div className="text-xs text-gray-500">Neu</div>
                    <div className="text-lg font-semibold text-white">{storageItem.quantity_new || 0}</div>
                  </div>
                  <div>
                    <div className="text-xs text-gray-500">Gebraucht</div>
                    <div className="text-lg font-semibold text-white">{storageItem.quantity_used || 0}</div>
                  </div>
                  <div>
                    <div className="text-xs text-gray-500">Nachgeschliffen</div>
                    <div className="text-lg font-semibold text-white">{storageItem.quantity_reground || 0}</div>
                  </div>
                </div>
                <p className="text-xs text-gray-500 mt-2">
